				...
				<div class="col-md-5">
					<div class="dd-main-menu">
						<ul id="js-nav">
							...
							<li><a href="#howitwork">Как я работаю</a></li>
	...
	<div class="header-wrap">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="dd-title">
						<span class="animated bounceInDown">Адаптивная верстка сайтов</span>
						<span class="animated bounceInDown">{ HTML5 } { CSS3 } { jQuery } { Bootstrap } { git } { Gulp }</span>
						<span class="animated bounceInDown">Быстро, Качественно, Низкие цены</span>
						<span class="animated bounceInLeft">"Верстка лендинга от 2000 руб."</span>
					</div>
					<div class="dd-button">
